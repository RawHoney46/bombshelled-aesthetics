...
**Verification depth scales with `asvs_level`** (see @C:/Users/User/Desktop/bombshelled-aesthetics-demo-final/bombshelled-aesthetics-main/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
