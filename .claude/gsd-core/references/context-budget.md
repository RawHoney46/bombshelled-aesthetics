...
The keys live in `.claude/settings.json` (project) or `C:/Users/User/Desktop/bombshelled-aesthetics-demo-final/bombshelled-aesthetics-main/.claude/settings.json` (global) — **not** in `.planning/config.json`:
